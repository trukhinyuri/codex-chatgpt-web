...
const en = {
  ...
  updating: "Updating…",
  updateReady: "Update ready — installs when Codex is idle",
  workspace: "Workspace",
...
const zh: Record<keyof typeof en, string> = {
  ...
  updateAvailable: "更新至",
  updating: "正在更新…",
  updateReady: "更新已就绪 — 将在 Codex 空闲时安装",
  workspace: "工作区",
  configuration: "配置",
  runtime: "运行时",
  browser: "浏览器",
...
const ja: Record<keyof typeof en, string> = {
  ...
  updating: "アップデート中…",
  updateReady: "アップデート準備完了 — Codex がアイドルになるとインストールされます",
  workspace: "ワークスペース",
  configuration: "構成",
  runtime: "ランタイム",
  browser: "ブラウザー",
...
const ko: Record<keyof typeof en, string> = {
  ...
  updating: "업데이트 중…",
  updateReady: "업데이트 준비 완료 — Codex가 유휴 상태일 때 설치됩니다",
  workspace: "작업 공간",
  configuration: "구성",
  runtime: "런타임",
  browser: "브라우저",
...
const zhTW: Record<keyof typeof en, string> = {
  ...
  updateAvailable: "更新至",
  updating: "正在更新…",
  updateReady: "更新已就緒 — 將在 Codex 閒置時安裝",
  workspace: "工作區",
  configuration: "組態",
  runtime: "執行階段",
  browser: "瀏覽器",

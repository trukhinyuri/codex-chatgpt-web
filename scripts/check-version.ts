...
const expected = [
  ...
  ["docs/upstream/README.md", `requires Bun ${bunVersion}.`],
  ["docs/upstream/README.zh-CN.md", `Bun ${bunVersion}`],
...
// The upstream README and its translations keep the upstream release links in sync with the version.
for (const path of ["docs/upstream/README.md", "docs/upstream/README.zh-CN.md", "docs/upstream/README.ja.md", "docs/upstream/README.ko.md"]) {
